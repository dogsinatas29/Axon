...
.../2026-03-01_0920_auto_push_after_drag.md        |    18 +
 ...
 .../2026-03-07_1113_auto_backup_autosave.md        |    65 +
 .../2026-03-07_1113_auto_push_after_drag.md        |    64 +
 ARCHITECTURE_AXON.md                               |     2 +-
 Cargo.lock                                         |   204 +
 Cargo.toml                                         |     1 +
 axon_config.json                                   |     4 +-
 data/project_state.json                            |   528 +-
 data/synapse_history.json                          | 91073 ++++++++++++++++++-
 junior_1.md                                        |     5 +
 senior.md                                          |     5 +
 src/cli.rs                                         |    12 +-
 src/core/mod.rs                                    |     2 +
 ...
 49 files changed, 92617 insertions(+), 985 deletions(-)
```
