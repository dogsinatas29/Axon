...
## 🛠️ Current Task: Calculator Module (Test)
- **Component**: `calculator.py`
- **Functions**:
  - `add(a: int, b: int) -> int`: Returns the sum of a and b.
  - `subtract(a: int, b: int) -> int`: Returns the difference of a and b.
- **Constraint**: Must use type hints. No external dependencies.
