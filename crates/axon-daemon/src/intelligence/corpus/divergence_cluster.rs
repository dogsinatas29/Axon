...
use crate::intelligence::replay::corpus_fingerprint::CorpusFingerprint;
...
pub struct DivergenceCluster {
    ...
    pub fingerprints: Vec<CorpusFingerprint>,
}
...
impl DivergenceClusteringEngine {
    ...
    pub fn cluster_failures(failures: Vec<CorpusFingerprint>) -> Vec<DivergenceCluster> {
