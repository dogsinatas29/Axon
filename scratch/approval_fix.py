...
# Update handle_semantic_decision to correctly handle 'pending_approval' and 'SEAL'
start_idx = -1
...
if start_idx != -1 and end_idx != -1:
    new_func = [
        ...
        "    let _comment = payload[\"comment\"].as_str().unwrap_or_default();\n",
        "\n",
        "    // v0.0.30: Boss Approval Gate Recovery\n",
        "    if risk_id == \"pending_approval\" {\n",
        "        let root = std::env::current_dir().unwrap_or_default();\n",
        "        // Check subdirectories for the approval file (TEST2/spec, etc.)\n",
        ...
        "                info!(\"✅ [SOVEREIGN_SEAL] Approval file removed. Factory gates opening...\");\n",
        "                found = true;\n",
        "                break;\n",
        "            }\n",
...
with open(path, "w") as f:
    f.writelines(lines)
print("Successfully patched server.rs for Approval Gate Recovery")
