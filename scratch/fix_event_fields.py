...
if start_idx != -1 and end_idx != -1:
    # Inject CORRECTED special case for "pending_approval"
    clean_func = [
        ...
        "\n",
        "                    if match_found {\n",
        "                        // v0.0.30: Fixed Event fields to match axon_core::Event definition\n",
    ...
    with open(path, "w") as f:
        f.writelines(lines)
    print("Successfully corrected Event struct fields in server.rs")
else:
