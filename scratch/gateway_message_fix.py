...
# Update pending_approval messages to be more intuitive
start_idx = -1
...
if start_idx != -1 and end_idx != -1:
    new_func = [
        ...
        "                 \"actor\": \"Sovereign Gatekeeper\",\n",
        "                 \"cause\": \"새로운 명세가 감지되었습니다. 제조 공정 시작을 위해 보스의 승인이 필요합니다.\",\n",
        "                 \"expected\": \"Authorized Specification (승인된 명세)\",\n",
        "                 \"detected\": \"New Design Draft (설계 초안 대기 중)\",\n",
        "                 \"recommendation\": \"[OVERRIDE \u0026 SEAL] 버튼을 눌러 공정 시작을 승인하십시오.\",\n",
        "                 \"component\": \"GATEWAY\",\n",
        "             }));\n",
        "        }\n",
...
with open(path, "w") as f:
    f.writelines(lines)
print("Successfully refined Gateway messages in server.rs")
