...
if start_idx != -1 and end_idx != -1:
    # Final, nested-aware deduplication logic
    clean_func = [
        ...
        "                            // v0.0.30: [NESTED_PRUNE] Remove nested risks to prevent dual-rendering in the UI\n",
    ...
    with open(path, "w") as f:
        f.writelines(lines)
    print("Successfully pruned nested risks and unified the decision track")
else:
